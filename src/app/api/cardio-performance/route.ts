...
export async function GET(request: Request) {
  console.log('Cardio performance API called');
  try {
    ...
    // Fetch cardio performance data
    const cardioData = await client.db("ayurview")
      .collection("cardioPerformance")
      .find({
    ...
    console.error("Error fetching cardio performance data:", error);
